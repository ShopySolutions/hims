...
public class CityResource {
    ...
    public ResponseEntity<City> createCity(@Valid @RequestBody City city) throws URISyntaxException {
        ...
        city.setCreateBy(userRepository.getCurrentUserId());
    ...
    public ResponseEntity<City> updateCity(@Valid @RequestBody City city) throws URISyntaxException {
        ...
        city.setUpdateBy(userRepository.getCurrentUserId());
        city.setUpdateDate(LocalDate.now());
        City result = cityRepository.save(city);
    ...
    @GetMapping("/cities/findCityByState/{state}")
    @Timed
    public List<City> findCityByState(@PathVariable Long state) {
        log.debug("REST request to get a page of state");
        List<City> page = cityRepository.findCityByState(state);
        return page;
    }
