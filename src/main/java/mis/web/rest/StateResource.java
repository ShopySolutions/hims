...
import mis.repository.StateRepository;
...
public class StateResource {
    ...
    public ResponseEntity<State> createState(@Valid @RequestBody State state) throws URISyntaxException {
        ...
        state.setCreatedate(java.time.LocalDate.now());
        state.setCreateby(userRepository.getCurrentUserId());
    ...
    public ResponseEntity<State> updateState(@Valid @RequestBody State state) throws URISyntaxException {
        ...
        state.setUpdatedate(java.time.LocalDate.now());
        state.setUpdateby(userRepository.getCurrentUserId());
    ...
    @GetMapping("/states/findStateByCountry/{country}")
    @Timed
    public List<State> findStateByCountry(@PathVariable Long country) {
        log.debug("REST request to get a page of States");
        List<State> page = stateRepository.findStateByCountry(country);
        return page;
    }
