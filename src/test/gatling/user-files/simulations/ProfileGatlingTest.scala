...
class ProfileGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Profile entity")
        ...
        .repeat(2) {
            ...
            .post("/api/profiles")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "firstName":"SAMPLE_TEXT", "lastName":"SAMPLE_TEXT", "mobileNo":"SAMPLE_TEXT", "telephoneNo":"SAMPLE_TEXT", "email":"SAMPLE_TEXT", "nidOrPassportNo":"SAMPLE_TEXT", "address":"SAMPLE_TEXT", "gender":"SAMPLE_TEXT", "religion":"SAMPLE_TEXT", "createdate":"2020-01-01T00:00:00.000Z", "createBy":null, "updateDate":"2020-01-01T00:00:00.000Z", "updateBy":null, "profileImage":null, "nidOrPassport":null}""")).asJSON
            .check(status.is(201))
