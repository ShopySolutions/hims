...
import mis.config.audit.AuditEventConverter;
import mis.domain.PersistentAuditEvent;
...
import static mis.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
